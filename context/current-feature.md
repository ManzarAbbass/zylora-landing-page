...
- **2026-07-17** — FAQ Section (Section 08): purple (`#6366F1`) section with BG.png background cover, centered serif heading with yellow italic &quot;Questions&quot;, 5 white rounded-2xl accordion rows with GSAP height/opacity expand-collapse and plus icon rotation (45&deg;), ScrollTrigger entrance animations, factual objection-ladder answers.
